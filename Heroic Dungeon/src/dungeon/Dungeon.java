...
public class Dungeon
{
    ...
    VibroBlade vibroBlade = new VibroBlade(20, 100);
    LaserGun laserGun = new LaserGun(10, 100);
...
//Opretter objekter:
        Room loadingBay = new Room(1, 0, ""
                ...
                + "\nit is found to the North. You must now decide what to do next!", "Hint: Try moving into the next room.", 0, null);
        Room changingRoom = new Room(4, 1, "\nThe light flickers are on, you are standing in a changing room surrounded by what "
                ...
                + "\nlabelled “Dormitory”. What will you do?", "Mabye it's a good idea to \"wear\" that suit..?", 0, null);
        Room dumbLoud1 = new Room(2, 2, "\nYou've entered a long hallway, with rocky sides, and stallecmites shooting up from the ground everywhere. "
                + "\nWhat will you do?", "Hint: Try moving on", 0, null);
        Room dumbLoud2 = new Room(2, 3, "\nYou continue into the dark of the mines, taking a hard right, still, this barren cave-system, gives you the creeps"
                + "\nWhat will you do?", "Hint: Try moving on", 2, null);
        Room dumbLoud3 = new Room(2, 4, "\nYou move through the caves only being able to see the cone of light that forms where you look. A sudden shadow moves"
                ...
                + "\ncave section. What will you do?", "Hint: Try moving on", 5, null);
        Room dumbLoud4 = new Room(2, 5, "\nA litte further down the tunnel, is a faint light, but what is casting it?", "Hint: What could that light be?", 0, null);
        Room dumbLoud5 = new Room(1, 6, "\nA dead end, but a dead end, filled with small Eridium chunks!", "Hint: Well, pick them up!", 8, null);
        Room ingenuitySmart1 = new Room(3, 7, "You enter the white walled halls of the dormitory, what might await you within...", "Hint: Try moving on.", 0, null);
        Room ingenuitySmart2 = new Room(2, 8, "\nYou enter a brightly lit room, the white walls are holey with large rocks protruding through. In the middle"
                ...
                "Hint: Feature not implemented yet, sorry.", 3, null);
        Room ingenuitySmart3 = new Room(2, 9, "An empty room, with a couple of tables thrown about, nothing really noteworthy.", "Hint: Try moving on", 0, null);
        Room ingenuitySmart4 = new Room(3, 10, "\nSomething catches your eyes! It was a mirror, you look at yourself, and review your face behinde the mask, "
                + "\n'damn I look tired” you mumble in the mask.'", "Try moving on", 3, null);
        Room ingenuitySmart5 = new Room(2, 11, "A light flickers, but doesn't completely turn on. There is a sign just beneath the lamp reading Sector G. "
                + "Does this remind you of something? What will you do?", "Hint: Feature not implemened yet, sorry.", 0, null);
        Room ingenuitySmart6 = new Room(1, 12, "\nThis room is a smugglers dream with lots of hidden away goods. It sparkles in your eyes, "
                ...
                + "\nhope you fare better on this Fujinforsaken rock!”" + "What will you do?", "Hint: You aren't suppose to be here...", 25, null);
        Room straightBland1 = new Room(2, 13, "You walk into the tunnel, it's steep, uphill clmibing.", "Hint: Try moving on", 1, v1);
        Room straightBland2 = new Room(3, 14, "You see a man, walking around the corner, you chase want to chase after him?", "Hint: Chase the man, whom went left!", 0, null);
        Room straightBland3 = new Room(2, 15, "You ignore the man and move straight, ", "Hint: You sure that man wasn't enticing? He wasn't wearing a suit...", 2, null);
        Room straightBland4 = new Room(2, 16, "You get around the corner, but nothing is there...", "Hint: Look for the man", 0, null);
        Room straightBland5 = new Room(3, 17, "You spot the man again, he is standing straight, staring at you", "Hint: Is he even human? Am I going crazy?", 1, null);
        Room straightBland6 = new Room(2, 18, "You move towards him, he.. flickers? you now realize he was a Hologram, all along.", "Hint: Such a dissapointment", 3, null);
        Room straightBland7 = new Room(2, 19, "You move further up a hillclimb inside the cavern, noticing a glow, at the end of the tunnel", "Hint: Is this what i think it is?", 0, null);
